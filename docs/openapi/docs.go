...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api_rest_notifications.ListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api_rest_notifications.UnreadCountResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "api_rest_notifications.ListResponse": {
            "type": "object",
            "properties": {
                "notifications": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api_rest_notifications.NotificationResponse"
                    }
                },
                "unread_count": {
                    "type": "integer"
        ...
        "api_rest_notifications.NotificationResponse": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string"
        ...
        "api_rest_notifications.UnreadCountResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
